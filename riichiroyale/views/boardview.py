...
class BoardView(MenuView):
  def __init__(self, name, game_manager, dialogue_manager, screen, tile_dict, small_tile_dict, screen_width, screen_height, width_ratio, height_ratio):
    ui_manager, process_ui_event = self.create_game_elements(screen_width, screen_height)
