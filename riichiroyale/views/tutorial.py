...
class TutorialView(BoardView):
  def __init__(self, game_manager, screen, tile_dict, small_tile_dict, screen_width, screen_height, width_ratio, height_ratio, name="tutorial"):
    ...
    super().__init__(name, game_manager, dialogue_manager, screen, tile_dict, small_tile_dict, screen_width, screen_height, width_ratio, height_ratio)
    self.tutorial = None
  ...
  def on_match_init(self):
    ...
    self.tutorial = Tutorial(prefered_discards, calls, Tile.THREE_PIN, wall, deadwall)
